...
if (!$id) {
  ...
  <div class="simple">
    ...
    <?php
//    echo Helper::translate('srbac', 'User') . ": " . SHtml::activeDropDownList($this->module->getUserModel(), $this->module->userid, SHtml::listData($this->module->getUserModel()->findAll($criteria), $this->module->userid, $this->module->username), array('disabled'=>'disabled', 'size' => 1, 'class' => 'dropdown', 'ajax' => array(
//            'type' => 'POST',
...
//    ));
    ...
    $data = $this->module->getUserModel()->findAll($criteria);
