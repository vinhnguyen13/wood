...
class CaptchaExtendedAction extends CCaptchaAction{
	...
	*/
	...
	protected function getCodeByNum()
	{
	    ...
	    $letters = '012345678901234567890123';
	    $vowels = '13579';
	    $code = '';
	    for($i = 0; $i < $length; ++$i)
	    {
	...
	*/
	...
	protected function renderImage($code){
		...
		for($i = 0; $i < $length; ++$i){
            ...
            $angle = !empty($this->angle) ? $angle : 0;
            $fontSize = !empty($this->fontSize) ? $this->fontSize : $fontSize;
            $foreColor = !empty($this->foreColor) ? $this->foreColor : $foreColor;
